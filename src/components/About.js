...
const About = () => {
    return (
        <div className="sezione lg:h-dvh">
            <h1 className="bg-logo text-white text-6xl lg:text-8xl">Chi Siamo</h1>
            <div className="lg:grid lg:grid-cols-3 grid-rows-2 lg:grid-rows-1 h-full lg:h-5/6 lg:m-6">
                ...
                <p className="lg:p-6 text-xl lg:text-2xl lg:col-start-2 lg:col-end-5 lg:row-start-1 m-auto bg-white/75 shadow-xl rounded-lg">
