...
const Clienti = () => {
    ...
    return (
        <div className="mt-10 w-full inline-flex flex-nowrap overflow-hidden h-32 lg:h-auto [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
            <ul
                ref={logosRef}
