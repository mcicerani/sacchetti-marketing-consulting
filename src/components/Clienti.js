...
const Clienti = () => {
    ...
    return (
        <div className="w-full inline-flex flex-nowrap overflow-hidden bg-gray-200/75 h-auto [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
            <ul
                ref={logosRef}
