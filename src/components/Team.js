...
const Team = () => {
    return (
        <div className="sezione h-dvh">
            <h1 className="bg-red-400 text-white text-8xl">Il Nostro Team</h1>
            <div className="flex justify-center items-center h-5/6">
                <ul className="flex flex-row justify-center items-center">
                    ...
                    <li className="flex flex-col mx-20 justify-center items-center">
                        <img src="manu.jpg" alt="Foto Emanuela Cittarelli" className="rounded-full h-96 grayscale ease-in-out duration-500 hover:grayscale-0  "/>
                        <h2 className="text-2xl my-3">
                            Emanuela Cittarelli
                        </h2>
                        <h3 className="text-xl">
